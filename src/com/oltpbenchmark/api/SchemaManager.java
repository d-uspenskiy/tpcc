...
public class SchemaManager {
    ...
    void enableForeignKeyConstraints() throws SQLException {
        ...
        execute("ALTER TABLE OORDER ADD CONSTRAINT O_FKEY_C FOREIGN KEY (O_W_ID, O_D_ID, O_C_ID) " +
                "REFERENCES CUSTOMER (C_W_ID, C_D_ID, C_ID) DEFERRABLE INITIALLY DEFERRED NOT VALID");
        ...
        execute("ALTER TABLE NEW_ORDER ADD CONSTRAINT NO_FKEY_O FOREIGN KEY " +
                "(NO_W_ID, NO_D_ID, NO_O_ID) REFERENCES OORDER (O_W_ID, O_D_ID, O_ID) DEFERRABLE INITIALLY DEFERRED NOT VALID NOT VALID");
        ...
        execute("ALTER TABLE ORDER_LINE ADD CONSTRAINT OL_FKEY_O FOREIGN KEY " +
                "(OL_W_ID, OL_D_ID, OL_O_ID) REFERENCES OORDER (O_W_ID, O_D_ID, O_ID) DEFERRABLE INITIALLY DEFERRED NOT VALID");
        execute("ALTER TABLE ORDER_LINE ADD CONSTRAINT OL_FKEY_S FOREIGN KEY " +
                "(OL_SUPPLY_W_ID, OL_I_ID) REFERENCES STOCK (S_W_ID, S_I_ID) DEFERRABLE INITIALLY DEFERRED NOT VALID");
    }
}
